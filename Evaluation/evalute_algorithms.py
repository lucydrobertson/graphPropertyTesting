...
if __name__ == "__main__":
    ...
    expander_harness = EvaluationHarness([25, 100, 250, 1000], [1 / 100, 1 / 50, 1 / 20, 1 / 10, 1 / 6, 1 / 4, 1 / 3],
                                         False)
    expander_harness.evaluate_expander_tester(facebook_graph, 5, [1/10, 1/5, 1/4, 1/3])
